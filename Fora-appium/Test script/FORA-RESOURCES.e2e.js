...
describe("fora", () => {
  ...
  it("Advisor_Resources_TC002", async () => {
    ...
    const email = await $(
      '//*[@id="main-container"]/main/div/div[1]/div[2]/dl/div[1]/div/a/span'
    );
    email.click();
    await browser.pause(10000);
...
cancel.click() */
  ...
  it("Advisor_Resources_TC003", async () => {
    ...
    const Itinerary = await $(
      '//*[@id="main-container"]/main/div/div[1]/div[2]/dl/div[2]/div/a/span'
    );
    Itinerary.click();
    await browser.pause(3000);
  });
  ...
  it("Advisor_Resources_TC004", async () => {
    ...
    const Forms = await $(
      '//*[@id="main-container"]/main/div/div[1]/div[2]/dl/div[3]/div/a/span'
    );
    Forms.click();
    await browser.pause(3000);
  });
  ...
  it("Advisor_Resources_TC005", async () => {
    ...
    const Other = await $(
      '//*[@id="main-container"]/main/div/div[1]/div[2]/dl/div[4]/div/a/span'
    );
    Other.click();
    await browser.pause(3000);
  });
