...
describe("fora", () => {
  ...
  const search_textbx = await $("//input[@placeholder='Find answers and resources']")
  if(!search_textbx.isDisplayed()) {
  throw new Error("search_textbx not displayed");
  }

  
  const help_fileds = await $(
    "//*[@id=\"main-container\"]/main/div/div[1]"
    );
    const textsToCheck = [
      "Ask the community",
      "Policy",
...
it.only("Advisor_Help_TC002", async () => {
  ...
  searchBtn.click()
  await browser.pause(3000)
  const nosearch = await $("//h3[normalize-space()='No search results found']")
  ...
  await browser.pause(3000)
  const result = await $$("//h2[contains(text(),'Testing That this Article Makes it to Algolia Sear')]")
  await browser.pause(2000)
  ...
  back.click()
  const ask_community = await $("//*[@id=\"main-container\"]/main/div/div[1]/div[2]/div/p");
...
it("Advisor_Help_TC003", async () => {
  ...
  const gotoForum = await $("//*[@id=\"main-container\"]/main/div/div[1]/div[2]/p/a")
...
it("Advisor_Help_TC004", async () => {
  ...
  const policy = await $("//*[@id=\"main-container\"]/main/div/div[1]/div[3]/div/a[1]");
  const texts = [
    "Policy",
    "See all",
  ];
  ...
  //to check policy section
  const seeAll = await $("//*[@id=\"main-container\"]/main/div/div[1]/div[3]/div/a[1]/div/div[2]/div/p")
  seeAll.click()
...
it("Advisor_Help_TC005", async () => {
  console.log("TC05............................................................... ");
  //check Tech section
  const tech = await $("//*[@id=\"main-container\"]/main/div/div[1]/div[3]/div/a[2]");
  const textsToCheck = [
  ...
  const newArticle = await $("//*[@id=\"main-container\"]/main/div/div[1]/div[3]/div/a[2]/div/a[1]");
  newArticle.click()
...
it("Advisor_Help_TC006", async () => {
  ...
  const membership = await $("//*[@id=\"main-container\"]/main/div/div[1]/div[3]/div/a[3]");
  const texts = [
    "Membership",
    "See all",
  ...
  //click see all
  const seeAll= await $("//*[@id=\"main-container\"]/main/div/div[1]/div[3]/div/a[3]/div/div[2]/div/p")
  seeAll.click()
  await browser.pause(2000)
  const helpwithmember= await $(`//*[contains(text(), 'Help with Membership')]`)
...
it("Advisor_Help_TC007", async () => {
  ...
  const booking = await $("//*[@id=\"main-container\"]/main/div/div[1]/div[3]/div/a[4]");
  const texts = [
    "Booking",
...
//click see all
const seeAll= await $("//*[@id=\"main-container\"]/main/div/div[1]/div[3]/div/a[4]/div/div[2]/div/p")
seeAll.click()
await browser.pause(2000)
...
back.click()*/
//clicking 2nd link
const link2= await $(`//*[contains(text(), 'How do I get a login for a supplier?')]`)
link2.click()
await browser.pause(2000)
...
await browser.pause(2000)
//clicking 3rd link
const link3= await $(`//*[contains(text(), 'How do I know the commission rate for any given supplier?')]`)
link3.click()
await browser.pause(2000)
...
await browser.pause(2000)
//clicking 4th link
const link4= await $(`//*[contains(text(), 'How does Fora calculate the commissionable amount in a booking?')]`)
link4.click()
await browser.pause(2000)
...
it("Advisor_Help_TC008", async () => {
  //finance
  console.log("TC08............................................................... ");
  const finance = await $("//*[@id=\"main-container\"]/main/div/div[1]/div[3]/div/a[5]");
  const texts = [
    "Finance",
    "[Staging] This is a New Article",
...
//click see all
const seeAll= await $("//*[@id=\"main-container\"]/main/div/div[1]/div[3]/div/a[5]/div/div[2]/div/p")
seeAll.click()
await browser.pause(2000)
...
//clicking 2nd link
const link2= await $(`//*[contains(text(), 'How do I collect payment information from my clients?')]`)
link2.click()
await browser.pause(2000)
if(!link2.isDisplayed()) {
  throw new Error("link2 not opened");
...
await browser.pause(2000)
//clicking 3rd link
const link3= await $(`//*[contains(text(), 'How do I update my bank details?')]`)
link3.click()
await browser.pause(2000)
if(!link3.isDisplayed()) {
  throw new Error("link2 not opened");
...
//clicking 4th link
const link4= await $(`//*[contains(text(), 'How do I complete a net rate booking?')]`)
link4.click()
await browser.pause(2000)
if(!link4.isDisplayed()) {
...
it("Advisor_Help_TC009", async () => {
  ...
  const training = await $("//*[@id=\"main-container\"]/main/div/div[1]/div[3]/div/a[6]");
  const texts = [
    "Training",
...
//click see all
const seeAll= await $("//*[@id=\"main-container\"]/main/div/div[1]/div[3]/div/a[6]/div/div[2]/div/p")
seeAll.click()
await browser.pause(2000)
...
const Marketing = await $("//*[@id=\"main-container\"]/main/div/div[1]/div[3]/div/a[7]");
const texts = [
  "Marketing",
  "See all",
];
...
//click see all
const seeAll= await $("//*[@id=\"main-container\"]/main/div/div[1]/div[3]/div/a[7]/div/div[2]/div/p")
seeAll.click()
await browser.pause(2000)
...
it("Advisor_Help_TC011", async () => {
  //report an issue
  console.log("TC11............................................................... ");
  const reportIssue= await $('//*[@id="main-container"]/main/div/div[2]/div')
  reportIssue.click()
//  console.log("click menu ");
...
const details_required= await $(`//*[contains(text(), 'Details are required')]`)
...
//select type
const type_dropdwn= await $('//*[@id="headlessui-popover-button-:r15:"]/svg"')
type_dropdwn.click()
await browser.pause(1000)
const cantFind_partner= await $(`//*[contains(text(), 'Can't find partner')]`)
cantFind_partner.click()
//enter details
const details= await $("//textarea[@placeholder='Please provide specific details about the issue. The more details you provide, the better we can address the problem and improve the experience.']")
await browser.pause(1000)
...
closeBtn.click()
const ask_community2 = await $("//*[@id=\"main-container\"]/main/div/div[1]/div[2]/div/p");
