describe("fora-appium", () => {
  ...
  it.skip("Advisor_clients_TC012", async () => {
  ...
  it.skip("Advisor_Clients_TC013", async () => {
  ...
  it("Advisor_Clients_TC014", async () => {
    ...
    const addressNamePlaceholder = await addressNameInputbox.getAttribute(
      "placeholder"
    );
    await expect(addressNamePlaceholder).toEqual("Example: Summer house");
    await addressNameInputbox.setValue("winter House");
    await addressName.click();

    // // Wait for the dropdown to be visible
    // const countryDropdown = await $("//input[contains(@id,'addresses')]");
    // await countryDropdown.waitForDisplayed();
    // // Click on the dropdown to open the options
    // //await countryDropdown.click();
    // await countryDropdown.setValue("United Kingdom");
    // await browser.pause(10000);
    // // Wait for the options to be visible
    // const usaOption = await $("#react-select-2-option-0");
    // await usaOption.waitForDisplayed();
    // // // Select the option for United States of America by its visible text
    ...
    await browser.pause(5000);
    const angola = await $(
      `//div[contains(text(), 'United States of America')]`
    );
    await angola.click();
  ...
  it.skip("Advisor_Clients_TC016", async () => {
